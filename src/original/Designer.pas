...
type
  TDesignerForm = class(TForm)
    ...
    procedure edEnergyEnter(Sender: TObject);
...
procedure TDesignerForm.edEnergyEnter(Sender: TObject);
begin
  Modified := True;
end;
...
begin
  if (StrToInt(edEnergy.Text)<20) or (StrToInt(edEnergy.Text)>200) then begin
